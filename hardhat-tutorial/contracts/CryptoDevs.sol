...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    // @dev_baseURI overrides the Openzeppelin's ERC721 implementation which by default returned an empty string for the baseURI
    ...
    // @dev withdraw sends all the ether in the contract the the owner of the contract
    function withdraw() public onlyOwner {
        address _owner = owner();
        uint256 amount = address(this).balance;
        (bool sent, ) = _owner.cal{value: amount}("");
